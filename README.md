...
This repository contains the full manuscript, individual chapter files, back-cover teaser, and supporting materials for the book **The Revelation Riddle** — a study built entirely on, and **grounded in, the King James Bible** and the biblical method of **typology** (Gal. 4:24; 1 Cor. 10:6,11).
...
- [Two Testaments - One Story](chapters/022_two_testaments_one_story.md)
- [The Two Witnesses - A ChatGPT Conversation](chapters/020_Two_Witnesses.md)
- [License (TXT)](manuscript/License.txt)
- [License (MARKDOWN)](chapters/023_License_Agreement.md)
